...
public:
    ...
    virtual void ErrorValues( const char *szWeaponName );
...
// Each game can decide to enable this or not.
extern bool g_bUseJSONScripts;
...
//
KeyValues *ReadEncryptedKVFile( IFileSystem *filesystem, const char *szFilenameWithoutExtension, const unsigned char *pICEKey, bool bForceReadEncryptedFile = false, bool bUseJSON = g_bUseJSONScripts );
